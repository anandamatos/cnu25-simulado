class GerenciadorProva {
    ...
    atualizarBotaoMarcar() {
        ...
        this.elements.btnMarcar.classList.toggle('btn-warning', isMarcada);
    }
    ...
    atualizarBotoesNavegacao() {
        ...
        this.elements.btnProxima.disabled = this.questaoAtual === this.questoes.length - 1;
    ...
    calcularResultado() {
        ...
        this.questoes.forEach((questao, index) => {
            ...
            const respostaCorreta = questao.respostaCorreta; // Assumindo que existe no JSON
